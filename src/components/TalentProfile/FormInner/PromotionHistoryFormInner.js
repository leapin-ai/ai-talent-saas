...
const PromotionHistoryFormInner = createWithRemoteLoader({
  ...
  return (
    <TableList
      ...
      title="晋升历史"
      list={[<DatePicker name="time" label="晋升时间" picker="month" format="YYYY-MM" rule="REQ" />, <Input name="occupation" label="岗位名称" rule="REQ LEN-0-100" />, <Input name="level" label="晋升等级" rule="REQ LEN-0-100" />]}
    />
  );
});
