...
const LeftColumn = createWithRemoteLoader({
  ...
  withLocale(({ remoteModules, saveProfile, profileData, advantages, certificates, promotionHistory, gotoPosition, readOnly, permissions, section = 'all' }) => {
    const { formatMessage } = useIntl();
    const [useFormModal] = remoteModules;
    const formModal = useFormModal();
    const strengthsOnly = section === 'strengths';
    ...
    return (
      <div className={style['left-column']}>
        ...
        {strengthsOnly ? null : (
          <>
            <CardGate request={permissions?.certificates}>
            ...
            <CardGate request={permissions?.promotionHistory}>
